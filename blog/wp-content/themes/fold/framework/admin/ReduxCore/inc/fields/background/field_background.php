        ...
        public function render() {
            ...
            if ($this->field['background-color'] === true) {
                ...
                if ( !isset( $this->field['transparent'] ) || $this->field['transparent'] !== false ) {
                    ...
                    echo '<label for="' . $this->field['id'] . '-transparency" class="color-transparency-check"><input type="checkbox" class="checkbox color-transparency redux-background-input ' . $this->field['class'] . '" id="' . $this->field['id'] . '-transparency" data-id="'.$this->field['id'] . '-color" value="1"'.$tChecked.'> '.__('Transparent', 'zoomarts').'</label>';       
                }
            ...
            if ( $this->field['background-repeat'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-repeat-select" data-placeholder="' . __( 'Background Repeat', 'zoomarts' ) . '" name="' . $this->field['name'] . '[background-repeat]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-repeat '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ( $this->field['background-clip'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-repeat-select" data-placeholder="' . __( 'Background Clip', 'zoomarts' ) . '" name="' . $this->field['name'] . '[background-clip]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-clip '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ( $this->field['background-origin'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-repeat-select" data-placeholder="' . __( 'Background Origin', 'zoomarts' ) . '" name="' . $this->field['name'] . '[background-origin]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-origin '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ( $this->field['background-size'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-repeat-select" data-placeholder="' . __( 'Background Size', 'zoomarts' ) . '" name="' . $this->field['name'] . '[background-size]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-size '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ( $this->field['background-attachment'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-attachment-select" data-placeholder="' . __( 'Background Attachment', 'zoomarts' ) . '" name="' . $this->field['name'] . '[background-attachment]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-attachment '.$this->field['class'].'">';
                    echo '<option></option>';
                    foreach ($array as $k=>$v) {
            ...
            if ( $this->field['background-position'] === true ) {
                ...
                echo '<select id="'.$this->field['id'].'-position-select" data-placeholder="' . __( 'Background Position', 'zoomarts' ) . '" name="' . $this->field['name'] . '[background-position]' . $this->field['name_suffix'] . '" class="redux-select-item redux-background-input background-position '.$this->field['class'].'">';
                    echo '<option></option>';
            ...
            if ($this->field['background-image'] === true) {
                ...
                $placeholder = isset($this->field['placeholder']) ? $this->field['placeholder'] : __('No media selected','zoomarts');
                ...
                echo '<span class="button background_upload_button" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'zoomarts' ) . '</span>';
                
                $hide = '';
                if( empty( $this->value['background-image'] ) || $this->value['background-image'] == '' )
                    $hide =' hide';

                echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'zoomarts' ) . '</span>';
