    ...
    class ReduxFramework_group {
        ...
        public function render() {
            ...
            //$field_is_title = true;
                ...
                echo '</table>';
                echo '<a href="javascript:void(0);" class="button deletion redux-groups-remove">' . __('Delete', 'zoomarts').' '. $this->field['groupname']. '</a>';
                echo '</div></div>';


            echo '</div><a href="javascript:void(0);" class="button redux-groups-add button-primary" rel-id="' . $this->field['id'] . '-ul" rel-name="' . $this->parent->args['opt_name'] . '[' . $this->field['id'] . '][slide_title][]">' . __('Add', 'zoomarts') .' '.$this->field['groupname']. '</a><br/>';
