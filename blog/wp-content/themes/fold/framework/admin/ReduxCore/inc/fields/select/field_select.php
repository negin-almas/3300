...
class ReduxFramework_select {
    ...
    function render() {
        ...
        if (!empty($this->field['options'])) {
            ...
            $placeholder = (isset($this->field['placeholder'])) ? esc_attr($this->field['placeholder']) : __('Select an item', 'zoomarts');
            ...
            echo '<strong>' . __('No items of this type were found.', 'zoomarts') . '</strong>';
        }
    }
...
//function
    ...
    function enqueue() {
        ...
        wp_enqueue_script(
                'field-select-js', ReduxFramework::$_url . 'inc/fields/select/field_select.js', array('jquery', 'select2-js'), time(), true
        );

        wp_enqueue_style(
                'redux-field-select-css', ReduxFramework::$_url . 'inc/fields/select/field_select.css', time(), true
        );
    }
