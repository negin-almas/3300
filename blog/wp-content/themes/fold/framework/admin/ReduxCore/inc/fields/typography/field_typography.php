...
class ReduxFramework_typography {
    ...
    private $std_fonts = array(
        "'BYekan', Tahoma, Arial" => "BYekan",
        "'WIranian', Tahoma, Arial" => "Iranian",
        "Tahoma, Arial" => "Tahoma",
    );
    /**
     * Field Constructor.
    ...
    function render() {
        ...
        if ($this->field['font-family'] === true) {
            ...
            echo '<select data-placeholder="' . __('Font family', 'zoomarts') . '" class="redux-typography redux-typography-family ' . $this->field['class'] . '" id="' . $this->field['id'] . '-family" data-id="' . $this->field['id'] . '" data-value="' . $fontFamily[0] . '">';
            ...
            if (($this->field['google'] == true && !empty($this->parent->args['google_api_key'])) || ($this->field['custom_fonts'] !== false && !empty($this->field['custom_fonts']))) {
                echo '<optgroup label="' . __('Standard Fonts', 'zoomarts') . '">';
            }
        ...
        if ($this->field['font-family'] === true && $this->field['google'] === true) {
            ...
            if ($this->field['font-backup'] === true) {
                ...
                echo '<select data-placeholder="' . __('Backup Font Family', 'zoomarts') . '" name="' . $this->field['name'] . '[font-backup]' . $this->field['name_suffix'] . '" class="redux-typography redux-typography-family-backup ' . $this->field['class'] . '" id="' . $this->field['id'] . '-family-backup" data-id="' . $this->field['id'] . '" data-value="' . $this->value['font-backup'] . '">';
                echo '<option data-google="false" data-details="" value=""></option>';
                foreach ($this->field['fonts'] as $i => $family) {
        ...
        if ($this->field['font-style'] === true || $this->field['font-weight'] === true):
            echo '<div class="select_wrapper typography-style" original-title="' . __('Font style', 'zoomarts') . '">';
            ...
            echo '<select data-placeholder="' . __('Style', 'zoomarts') . '" class="redux-typography redux-typography-style select' . $this->field['class'] . '" original-title="' . __('Font style', 'zoomarts') . '" id="' . $this->field['id'] . '_style" data-id="' . $this->field['id'] . '" data-value="' . $style . '">';
        ...
        if ($this->field['font-family'] === true && $this->field['subsets'] === true && $this->field['google'] === true):
            echo '<div class="select_wrapper typography-script tooltip" original-title="' . __('Font subsets', 'zoomarts') . '">';
            echo '<select data-placeholder="' . __('Subsets', 'zoomarts') . '" class="redux-typography redux-typography-subsets' . $this->field['class'] . '" original-title="' . __('Font script', 'zoomarts') . '"  id="' . $this->field['id'] . '-subsets" name="' . $this->field['name'] . '[subsets]' . $this->field['name_suffix'] . '" data-value="' . $this->value['subsets'] . '" data-id="' . $this->field['id'] . '" >';
        ...
        if ($this->field['text-align'] === true):
            echo '<div class="select_wrapper typography-align tooltip" original-title="' . __('Text Align', 'zoomarts') . '">';
            echo '<select data-placeholder="' . __('Text Align', 'zoomarts') . '" class="redux-typography redux-typography-align' . $this->field['class'] . '" original-title="' . __('Text Align', 'zoomarts') . '"  id="' . $this->field['id'] . '-align" name="' . $this->field['name'] . '[text-align]' . $this->field['name_suffix'] . '" data-value="' . $this->value['text-align'] . '" data-id="' . $this->field['id'] . '" >';
            echo '<option value=""></option>';
            $align = array(
                'inherit',
                'left',
        ...
        if ($this->field['text-transform'] === true){
            echo '<div class="select_wrapper typography-transform tooltip" original-title="' . __('Text Transform', 'zoomarts') . '">';
            echo '<select data-placeholder="' . __('Text Transform', 'zoomarts') . '" class="redux-typography redux-typography-transform' . $this->field['class'] . '" original-title="' . __('Text Transform', 'zoomarts') . '"  id="' . $this->field['id'] . '-transform" name="' . $this->field['name'] . '[text-transform]' . $this->field['name_suffix'] . '" data-value="' . $this->value['text-transform'] . '" data-id="' . $this->field['id'] . '" >';
            echo '<option value=""></option>';
            $values = array(
                'none',
                'capitalize',
        ...
        if ($this->field['font-size'] === true):
            echo '<div class="input-append"><input type="text" qtip-tip="Size" class="span2 redux-typography redux-typography-size mini' . $this->field['class'] . ' redux-typography-qtip" title="' . __('Size', 'zoomarts') . '" placeholder="' . __('Size', 'zoomarts') . '" id="' . $this->field['id'] . '-size" name="' . $this->field['name'] . '[font-size]' . $this->field['name_suffix'] . '" value="' . str_replace($unit, '', $this->value['font-size']) . '" data-value="' . str_replace($unit, '', $this->value['font-size']) . '"><span class="add-on">' . $unit . '</span></div>';
        ...
        if ($this->field['line-height'] === true):
            echo '<div class="input-append"><input type="text" qtip-tip="Height" class="span2 redux-typography redux-typography-height mini' . $this->field['class'] . ' redux-typography-qtip" title="' . __('Height', 'zoomarts') . '" placeholder="' . __('Height', 'zoomarts') . '" id="' . $this->field['id'] . '-height" value="' . str_replace($unit, '', $this->value['line-height']) . '" data-value="' . str_replace($unit, '', $this->value['line-height']) . '"><span class="add-on">' . $unit . '</span></div>';
        ...
        if ($this->field['color'] === true):
            ...
            echo '<input data-default-color="' . $default . '" class="redux-color redux-typography-color' . $this->field['class'] . '" original-title="' . __('Font color', 'zoomarts') . '" id="' . $this->field['id'] . '-color" name="' . $this->field['name'] . '[color]' . $this->field['name_suffix'] . '" type="text" value="' . $this->value['color'] . '" data-id="' . $this->field['id'] . '" />';
        endif;
        ...
        if (!isset($this->field['preview']) || $this->field['preview'] !== false):
            if (isset($this->field['preview']['text'])) {
                ...
                $g_text = 'توانا بود هر که دانا بود، ز دانش دل پیر برنا بود';
            }
    ...
    function getGoogleArray() {
        ...
        if (!isset($this->parent->fonts['google']) || empty($this->parent->fonts['google'])) {
            ...
            $this->parent->font_groups['google'] = array(
                'id'      => 'google',
                'text'    => __('Google Webfonts', 'zoomarts'),
                'children'=> array(),
            );
    ...
    function getGoogleFonts() {
        ...
        $gfonts = '<optgroup label="' . __('Google Webfonts', 'zoomarts') . '">';
