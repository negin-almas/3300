<?php
	...
	global $post;
	$page_layout = zoomarts_option('search-layout');
	$cols_class = 'col-md-8';
    ...
    <div id="main-content" class="container">
		...
		<div class="row">
			<div class="<?php echo $cols_class; ?>">
				<h2 class="search-results-title"><?php _e('Search results for', 'zoomarts') ?> <span>&#8220;<?php the_search_query(); ?>&#8221;</span></h2>
			</div>
		</div>
		...
		<div class="row">
			...
			<?php if ( zoomarts_option('blog-pagination-style') == 'load-more' ) : ?>
				...
				<div id="ajax-load-more" class="blog-posts <?php echo $cols_class; ?>">
					...
					<div class="listing" data-path="<?php echo get_template_directory_uri(); ?>" data-post-type="post" data-category="" data-taxonomy="" data-tag="" data-search="<?php echo $_GET["s"]; ?>" data-display-posts="<?php echo zoomarts_option('pagination-load-more-posts-num'); ?>" data-scroll="true" data-max-pages="5" data-button-text="<?php _e('Older Posts', 'zoomarts'); ?>" data-transition="<?php echo zoomarts_option('pagination-load-more-transtion'); ?>"></div>
