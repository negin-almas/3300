			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				<header class="entry-header">
					...
					<div class="entry-meta">
						<?php
							$post_date = (function_exists('jdate')) ? jdate(get_option('date_format'), strtotime($post->post_date)) : get_the_date();
						?>
						<span class="entry-date"><time class="entry-date" datetime="<?php echo esc_attr( get_the_date( 'c' ) ); ?>"><?php echo esc_html( $post_date ); ?></time></span>
