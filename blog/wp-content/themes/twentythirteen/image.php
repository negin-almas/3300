				...
				<header class="entry-header">
					...
					<div class="entry-meta">
						<?php
							...
							$param_2 = (function_exists('jdate')) ? esc_attr( jdate('c',strtotime($post->post_date)) ) : esc_attr( get_the_date( 'c' ) );
							$param_3 = (function_exists('jdate')) ? esc_html( jdate(get_option('date_format'), strtotime($post->post_date)) ) : esc_html( get_the_date() );
