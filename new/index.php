	...
	<div class="collapse navbar-collapse"
		...
		<ul class="nav navbar-nav">
			<li class="active"><a href="#home"
			                      class="page-scroll">خانه</a></li>
			<li><a href="#traffic"
			       class="page-scroll">تامین ترافیک</a></li>
			<li><a href="#panel"
			       class="page-scroll">سامانه ها</a></li>
			<li><a href="#webservice"
			       class="page-scroll">وب سرویس</a></li>
			<li><a href="#bulk"
			       class="page-scroll">ارسال تبلیغاتی</a></li>
			<li><a href="#about"
			       class="page-scroll">نگین ارتباط</a></li>
			<li><a href="#contact"
			       class="page-scroll">تماس با ما</a></li>
		</ul>
	</div>
</nav>
<section id="home">
	<div class="center-container">
		<div class="center-field">
			...
			<a class="btn btn-login"
			   ...
			   target="_blank">ورود به سامانه پیامک نگین</a>
			...
			<p>
				<button type="button"
				        data-toggle="modal"
				        data-target="#login"
				        class="btn-link"><i class="fa fa-globe"></i> ورود به دیگر سامانه ها
				</button>
			</p>

			<p><a href="documents.html"
			      class="btn-link"><i class="fa fa-file-text"></i> مستندات فروش</a></p>

			<div class="go-down"><span class="fa fa-angle-down"></span></div>
		</div>
	</div>
</section>
<section id="traffic">
	<div class="center-container">
		<div class="center-field">
			<div class="container">
				...
				<a href="#"
				   class="btn btn-warning btn-lg">اطلاعات بیشتر و قیمت ها</a>
			</div>
		</div>
	</div>
</section>
								...
								<div class="row">
									<div class="col-lg-9">
										<p>در صورتی که شما چند شماره داشته باشید می توانید آنها را توسط سامانه
										   ...
										   ارسال
										   می توانید تعیین
										   کنید پیامک شما با کدام شماره ارسال شود.</p>
									</div>
									<div class="col-lg-3">
										<img class="img-responsive"
								...
								<div class="row">
									<div class="col-lg-9">
										...
										<p><b>ارسال مناسبتی:</b> ممکن است قصد داشته باشید مخاطبین شما در روز معینی پیامک
										                         دریافت
										                         کنند، به عنوان مثال شنبه هر هفته</p>
								...
								<div class="row">
									<div class="col-lg-9">
										<p>در صورتی که قصد یک ارتباط دو طرفه با مخاطبین خود دارید، دریافت پیامک مخاطبین
										   ...
										   اساس
										   مولفه های مختلف پیامک دریافتی را مطالعه و تفکیک می نماید.</p>
									</div>
									<div class="col-lg-3">
										<img class="img-responsive"
										     src="images/rasel.png"
				...
				<div class="row">
					<div class="col-lg-offset-1 col-lg-7">
						<p>استفاده از سامانه بر روی مرورگر تلفن همراه تجربه دلچسبی نیست، لذا با استفاده از راسل که یک
						   ...
						   شما
						   نخواهد
						   داشت، در صورتی که گوشی شما به اینترنت دستری داشته باشد، امکانات بیشتری در ارسال خواهید
						   داشت.</p>
					</div>
					<div class="col-lg-3">
						<img class="img-responsive"
				...
				<div class="row">
					<div class="col-lg-12">
						<p>ارسال پیامک تکی و آرایه ای(چند تایی) را فراهم می نماید. و امکان دریافت پیامک ارسال شده به
						   ...
						   را
						   مهیا می
						   کند (البته در خصوص دریافت، سرویس انتقال ترافیک توصیه می شود). </p>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-4">
				...
				<div class="col-lg-4">
					<div class="well well-sm">
						...
						<p>در این ارسال، مبنا کدپستی است که مشترکین همراه اول قبض خود را دریافت می کنند، بدیهی است این
						   ارسال
						   صرفا
						   برای مشترکین دائمی صورت می گیرد.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="well well-sm">
			...
			<div class="container">
				<div class="row">
					...
					<textarea class="form-control"
							...
							<div class="form-group">
								<p>تکمیل فیلد های دارای <span class="text-danger">*</span> الزامی است.</p>
							</div>
				...
				<div class="row address">
					<div class="col-lg-3 col-lg-offset-3 text-left">
						...
						<p>خیابان شهید چمران</p>

						<p>چمران 5، پلاک 67</p>

						<p>کدپستی 9137687171</p>
					...
					<div class="col-lg-3 text-right">
						...
						<p><a href="mailto:info@3300.ir">info@3300.ir</a></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"
				    id="login-label">ورود به سامانه ها</h4>
			</div>
			<div class="modal-body">
				<p class="text-center">
					<a href="#"
					   class="btn btn-primary">سامانه پیامک کانکتور</a>
				</p>

				<p class="text-center">
					<a href="#"
					   class="btn btn-primary">سامانه تمدید</a>
				</p>

				<p class="text-center">
					<a href="#"
					   class="btn btn-primary">خرید اعتبار پیامک</a>
				</p>

				<p class="text-center">
					<a href="#"
					   class="btn btn-primary">واریز به حساب</a>
				</p>
			</div>
...
<a class="go-top page-scroll"
   href="#home"><i class="fa fa-angle-up"></i></a>
